...
public class RankingRow implements Serializable {
	...
	public RankingRow(String ipAddress, int sqlInjection, int blindSqlInjection, int emailWithoutAt, int xss, int profile_picture,
		...
		this.points=points;
		this.sqlInjection= sqlInjection != 0;
		this.blindSqlInjection = blindSqlInjection != 0;
		this.emailWithoutAt = emailWithoutAt != 0;
		this.xss = xss != 0;
		this.profile_picture= profile_picture != 0;
		this.htmlCommentUser = htmlCommentUser != 0;
		this.priceOrderBug= priceOrderBug != 0;
		this.guessUserLogin = guessUserLogin != 0;
		this.guessCoupon = guessCoupon != 0;
		this.deleteUser = deleteUser != 0;
		this.commentXss= commentXss != 0;
		this.lookForEmailAddress = lookForEmailAddress != 0;
		this.hashUser = hashUser != 0;
	}
