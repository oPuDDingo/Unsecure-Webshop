...
public class DatabaseQueries {
    ...
    public static User[] users = new User[]{new User(1, "Test1@test.de", "test", "test", false, "", "", "", "Test User", "123456789"),
    new User(2, "Test2@User.de", "test", "test", false, "", "", "", "Test User", "test123456789"),
            new User(3, "Test3@User.de", "test", "test", false, "", "", "", "Test User", "12345testUser6789")};
